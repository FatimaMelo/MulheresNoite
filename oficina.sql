...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/02/2023 às 23:48
...
(2, 'Pedro Santos', '(21)99911-2222', '123456789-13', 'mecânico', '10 anos', '23085-610', 31, 'fundos', 'pedro', '1234', 'I', ''),
...
INSERT INTO `item` (`iditem`, `codigopeca`, `quantidade`, `valor`, `idvenda`) VALUES
(4, 8, 3, 50, 6),
(5, 2, 3, 530, 6);
...
(2, 'amortecedores ', 'nakata', 'Renault Sandero,logan 2010/2011/2012', 4, 530, 'produtos/63d85f9194b22.jpg', 1),
(3, 'peça1', 'magneti mareli', 'de 2000/2010', 28, 50, 'produtos/63d85f9194b22.jpg', 1),
...
(8, 'Parachoque fusca', 'vw', '1970/1980', 7, 50, 'produtos/63daf80b472d4.jpg', 4);
...
ALTER TABLE `venda`
  ...
  ADD KEY `fk_funcionario` (`matricula`);
...
--
ALTER TABLE `item`
  ADD CONSTRAINT `fk_peca` FOREIGN KEY (`codigopeca`) REFERENCES `peca` (`codigopeca`),
...
--
ALTER TABLE `venda`
  ADD CONSTRAINT `fk_funcionario` FOREIGN KEY (`matricula`) REFERENCES `funcionario` (`matricula`);
COMMIT;
